...
-type table() :: map().
-define(TABLE_NAME, <<"ComplexActionGroup">>).

-spec decode(sora_runtime:reader()) -> {t(), sora_runtime:reader()}.
decode(Reader0) ->
    {Id, Reader1} = (fun sora_runtime:read_i32/1)(Reader0),
    {Name, Reader2} = (fun sora_runtime:read_string/1)(Reader1),
    {Actions, Reader3} = (fun(Reader) -> sora_runtime:read_list(fun reward_action:decode/1, Reader) end)(Reader2),
    {#{
        'id' => Id,
        'name' => Name,
        'actions' => Actions
...
-spec rows(table()) -> #{integer() => complex_action_group:t()}.
rows(Table) ->
    maps:get(data, Table).
