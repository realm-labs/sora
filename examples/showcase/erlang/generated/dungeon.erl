...
decode_value(Value) ->
    ...
    #{
        ...
        'stage_ids' => sora_runtime:decode_value_list(fun(Item) -> sora_runtime:expect_integer(Item) end, sora_runtime:value_get(<<"stage_ids">>, Obj)),
        'entry_cost' => resource_cost:decode_value(sora_runtime:value_get(<<"entry_cost">>, Obj))
    }.
