...
class_name ComplexRuleCondition
extends RefCounted
var id: int = 0
var rule_id: int = 0
var value: EventCondition = null

static func decode(value: Variant) -> ComplexRuleCondition:
	if value == null:
		return null
	if typeof(value) != TYPE_DICTIONARY:
		SoraRuntime.report_error("expected object for ComplexRuleCondition")
		return null
...
class ComplexRuleConditionTable:
	...
	static func decode(rows: Array) -> ComplexRuleConditionTable:
		var table := ComplexRuleConditionTable.new()
