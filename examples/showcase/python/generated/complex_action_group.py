...
class ComplexActionGroupTable(SoraConfigTable, Mapping[int, ComplexActionGroup]):
    ...
    def __getitem__(self, key: int) -> ComplexActionGroup:
    ...
    @property
    def ordered_rows(self) -> tuple[ComplexActionGroup, ...]:
