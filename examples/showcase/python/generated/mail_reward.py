...
class MailRewardTable(SoraConfigTable, Sequence[MailReward]):
    NAME = "MailReward"
    INFO = SoraTableInfo(
        name=NAME,
        row_type="MailReward",
    ...
    def __getitem__(self, index: int | slice) -> MailReward | list[MailReward]:
        return self._rows[index]

    def __iter__(self) -> Iterator[MailReward]:
