...
impl super::runtime::SoraDecode for ItemId {
    fn decode(
...
impl super::runtime::SoraDecode for Item {
    fn decode(
        ...
        Ok(Self {
            id: <ItemId as super::runtime::SoraDecode>::decode(reader)?,
...
pub struct ItemTable {
    ...
    by_name: SoraMap<std::sync::Arc<str>, ItemId>,
    by_item_type: SoraMap<super::item_type::ItemType, Vec<ItemId>>,
}
...
impl ItemTable {
    ...
    pub fn get(&self, key: &ItemId) -> Option<&Item> {
        self.rows.get(key)
    }

    pub fn keys(&self) -> &[ItemId] {
        &self.keys
    }
...
impl std::ops::Deref for ItemTable {
    type Target = SoraMap<ItemId, Item>;
