...
function SoraConfig.from_bytes(bytes)
    ...
    return setmetatable({
        _item = Item.Table.decode(bundle:decode_table("Item", Item.decode)),
        _skill = Skill.Table.decode(bundle:decode_table("Skill", Skill.decode)),
        _quest = Quest.Table.decode(bundle:decode_table("Quest", Quest.decode)),
        _quest_reward = QuestReward.Table.decode(bundle:decode_table("QuestReward", QuestReward.decode)),
        _game_settings = GameSettings.Table.decode(bundle:decode_table("GameSettings", GameSettings.decode)),
        _localization = Localization.Table.decode(bundle:decode_table("Localization", Localization.decode)),
        _level_exp = LevelExp.Table.decode(bundle:decode_table("LevelExp", LevelExp.decode)),
        _character = Character.Table.decode(bundle:decode_table("Character", Character.decode)),
        _character_skill = CharacterSkill.Table.decode(bundle:decode_table("CharacterSkill", CharacterSkill.decode)),
        _buff = Buff.Table.decode(bundle:decode_table("Buff", Buff.decode)),
        _drop_group = DropGroup.Table.decode(bundle:decode_table("DropGroup", DropGroup.decode)),
        _drop_entry = DropEntry.Table.decode(bundle:decode_table("DropEntry", DropEntry.decode)),
        _monster = Monster.Table.decode(bundle:decode_table("Monster", Monster.decode)),
        _stage = Stage.Table.decode(bundle:decode_table("Stage", Stage.decode)),
        _stage_reward = StageReward.Table.decode(bundle:decode_table("StageReward", StageReward.decode)),
        _dungeon = Dungeon.Table.decode(bundle:decode_table("Dungeon", Dungeon.decode)),
        _shop = Shop.Table.decode(bundle:decode_table("Shop", Shop.decode)),
        _shop_item = ShopItem.Table.decode(bundle:decode_table("ShopItem", ShopItem.decode)),
        _recipe = Recipe.Table.decode(bundle:decode_table("Recipe", Recipe.decode)),
        _gacha_pool = GachaPool.Table.decode(bundle:decode_table("GachaPool", GachaPool.decode)),
        _gacha_item = GachaItem.Table.decode(bundle:decode_table("GachaItem", GachaItem.decode)),
        _equipment_set = EquipmentSet.Table.decode(bundle:decode_table("EquipmentSet", EquipmentSet.decode)),
        _achievement = Achievement.Table.decode(bundle:decode_table("Achievement", Achievement.decode)),
        _vip_level = VipLevel.Table.decode(bundle:decode_table("VipLevel", VipLevel.decode)),
        _mail_template = MailTemplate.Table.decode(bundle:decode_table("MailTemplate", MailTemplate.decode)),
        _mail_reward = MailReward.Table.decode(bundle:decode_table("MailReward", MailReward.decode)),
        _dialogue = Dialogue.Table.decode(bundle:decode_table("Dialogue", Dialogue.decode)),
        _event_rule = EventRule.Table.decode(bundle:decode_table("EventRule", EventRule.decode)),
    }, SoraConfig)
end
