...
pub use mutation::{
    ...
    FieldDefinition, FieldOwner, FieldOwnerKind, IndexDefinition, LocalizationChange,
    MutableTableSource, MutationPlanError, MutationSchemaEntityKind, ProjectInitApplyReport,
    ProjectInitPlan, ProjectInitPlanFile, RowChange, RowSelector, SchemaApplyReport,
    SchemaExecution, SchemaMutationError, SchemaMutationPlan, SchemaOperation, SchemaTableMode,
