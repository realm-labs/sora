...
use crate::{
    ...
    service::{
        load_studio_schema, preview_studio_schema, project_text_with_package, write_studio_schema,
    },
};
...
"#,
    ...
    let rendered = project_text_with_package(&project, "game_config").unwrap();
